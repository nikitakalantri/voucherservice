...
public class VoucherServiceImplTests {
	...
	@InjectMocks
	static VoucherServiceImpl voucherServiceImpl;
	...
	@ParameterizedTest
	public static void findAllTest(@RequestParam(defaultValue = "0") Integer pageNo,
			@RequestParam(defaultValue = "5") Integer pageSize,
			@RequestParam(defaultValue = "voucherType") String sortBy) {
		...
		List<VoucherModel> voucherList = voucherServiceImpl.findAll(pageNo, pageSize, sortBy);
